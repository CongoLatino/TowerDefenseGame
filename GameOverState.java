...
/**
 * State of game responsible for game over 
 * @author kuba
 */
public class GameOverState extends BasicGameState {
    ...
    /**
     * 
     * @return ID of gameOver state game
     */
    @Override
    public int getID() {
        return 3;
    ...
    /**
     * Inits values at the beginning of the game over state
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
        try {
            gameOverBackground = new Image("sprites/gameOver.png");
